...
Liste_De_Mots = ["Cretes", "Camper", "Armure", "Argent", "Lingot", "Tondre", "Manger", "Wagons","Tomber","Extras","Torche","Pierre","Rocher","Banane","Bonnet","Tester","Valise","Chaton","Chemin"]
Mot_Aleatoire = random.randint(0,19)
